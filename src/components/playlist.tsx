...
export default function Playlist() {
  return (
    <div className="p-4 text-white bg-[#1e1e1e] rounded flex flex-col pt-16">
      ...
      <div className="grid grid-cols-6 grid-auto-rows-auto gap-4">
        {playlistData.map((item, index) => (
          <div className="relative p-4 w-full cursor-pointer bg-[#181818] rounded-lg flex flex-col hover:bg-zinc-800 transition duration-300 ease">
            <div key={index} className="w-full h-full mb-[16px]">
