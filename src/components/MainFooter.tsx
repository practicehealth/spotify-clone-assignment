...
const MainFooter = () => {
  return (
    <div className=" pt-1 pb-10 px-8 flex items-center justify-between flex-col flex-none">
      <div className="flex  justify-between items-start w-full">
        ...
        <div className="text-sm flex gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex mt-2 flex-col">
              <a
                href="#"
                className="text-gray-600 font-semibold hover:text-white  py-1 rounded-lg transition-colors duration-300 ease-in-out mr-2"
              >
              ...
              <a
                href="#"
                className="text-gray-600 font-semibold hover:text-white  py-1 rounded-lg transition-colors duration-300 ease-in-out"
              >
        ...
        <div className="flex ">
          <div className="flex items-center">
            <a
              href="#"
              className="block p-1 rounded-full bg-white hover:bg-gray-300 transition-colors duration-300 ease-in-out mr-2"
            >
            ...
            <a
              href="#"
              className="block p-1 rounded-full bg-white hover:bg-gray-300 transition-colors duration-300 ease-in-out"
            >
      ...
      <div className="text-sm flex w-full pt-4 text-gray-600 font-semibold">
        © 2024 Spotify AB{" "}
      </div>
    </div>
  );
