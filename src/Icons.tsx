...
const CollectionIcon: React.FC<IconProps> = ({ size = 24 }) => {
  return (
    <svg viewBox="0 0 512 512" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
...
const PlusIcon: React.FC<IconProps> = ({ size = 24 }) => {
  return (
    <svg viewBox="0 0 16 16" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
...
const PlayIcon: React.FC<IconProps> = ({ size = 24 }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" height={size}>
